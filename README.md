...
- English
  ...
  - [Django Riffs](https://djangoriffs.com/)A podcast for learning the Django Web Framework exploring all features to equip listeners with the knowledge to build a web app.
